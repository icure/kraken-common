...
@Mapper(componentModel = "spring", uses = [DelegationV2Mapper::class, CodeStubV2Mapper::class, SecurityMetadataV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
