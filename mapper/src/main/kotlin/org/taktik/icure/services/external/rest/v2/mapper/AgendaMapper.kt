...
@Mapper(componentModel = "spring", uses = [PropertyStubV2Mapper::class, CodeStubV2Mapper::class, RightV2Mapper::class, EmbeddedTimeTableV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
