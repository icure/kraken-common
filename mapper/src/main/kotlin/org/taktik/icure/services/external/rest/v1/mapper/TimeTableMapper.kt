...
@Mapper(componentModel = "spring", uses = [TimeTableItemMapper::class, CodeStubMapper::class, DelegationMapper::class, SecurityMetadataMapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
