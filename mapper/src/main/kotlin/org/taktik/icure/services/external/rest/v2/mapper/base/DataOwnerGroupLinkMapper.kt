...
interface DataOwnerGroupLinkV2Mapper {
	fun map(dataOwnerGroupLinkDto: DataOwnerGroupLinkDto): DataOwnerGroupLink

	fun map(dataOwnerGroupLink: DataOwnerGroupLink): DataOwnerGroupLinkDto
}
