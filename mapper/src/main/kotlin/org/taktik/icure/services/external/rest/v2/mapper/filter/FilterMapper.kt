...
import org.taktik.icure.services.external.rest.v2.dto.filter.healthelement.HealthElementByAssociationIdFilter
...
import org.taktik.icure.services.external.rest.v2.dto.filter.healthelement.HealthElementByQualifiedLinkFilter
...
abstract class FilterV2Mapper {
	...
	abstract fun map(filterDto: AllPricingFilter): org.taktik.icure.domain.filter.impl.pricing.AllPricingFilter
	abstract fun map(filterDto: PricingByRegionTypesLanguageLabelFilter): org.taktik.icure.domain.filter.impl.pricing.PricingByRegionTypesLanguageLabelFilter

	@JvmName("tryMapPricingFilter")
	fun tryMap(filterDto: AbstractFilterDto<TarificationDto>): AbstractFilter<Tarification>? = when (filterDto) {
		is AllPricingFilter -> map(filterDto)
		is PricingByRegionTypesLanguageLabelFilter -> map(filterDto)
		else -> mapGeneralFilterToDomain(filterDto) { tryMap(it) }
	}
	...
	abstract fun map(filterDto: HealthElementByHcPartyIdentifiersVersioningFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByHcPartyIdentifiersVersioningFilter
	abstract fun map(filterDto: HealthElementByHcPartyStatusVersioningFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByHcPartyStatusVersioningFilter
	abstract fun map(filterDto: HealthElementByHcPartyTagFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByHcPartyTagFilter
	abstract fun map(filterDto: HealthElementByHcPartyCodeFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByHcPartyCodeFilter
	...
	abstract fun map(filterDto: HealthElementByQualifiedLinkFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByQualifiedLinkFilter
	abstract fun map(filterDto: HealthElementByAssociationIdFilter): org.taktik.icure.domain.filter.impl.healthelement.HealthElementByAssociationIdFilter
	...
	fun tryMap(filterDto: AbstractFilterDto<HealthElementDto>): AbstractFilter<HealthElement>? = when (filterDto) {
		...
		is HealthElementByHcPartyIdentifiersVersioningFilter -> map(filterDto)
		is HealthElementByHcPartyStatusVersioningFilter -> map(filterDto)
		is HealthElementByHcPartyTagFilter -> map(filterDto)
		is HealthElementByHcPartyCodeFilter -> map(filterDto)
		...
		is HealthElementByQualifiedLinkFilter -> map(filterDto)
		is HealthElementByAssociationIdFilter -> map(filterDto)
		else -> mapGeneralFilterToDomain(filterDto) { tryMap(it) }
	}
	...
	abstract fun map(filterDto: ServiceByHcPartyMonthCodePrefixFilter): org.taktik.icure.domain.filter.impl.service.ServiceByHcPartyMonthCodePrefixFilter
	abstract fun map(filterDto: ServiceByHcPartyMonthTagPrefixFilter): org.taktik.icure.domain.filter.impl.service.ServiceByHcPartyMonthTagPrefixFilter
	abstract fun map(filterDto: ServiceByHcPartyPatientCodePrefixFilter): org.taktik.icure.domain.filter.impl.service.ServiceByHcPartyPatientCodePrefixFilter
	...
	fun tryMap(filterDto: AbstractFilterDto<ServiceDto>): AbstractFilter<Service>? = when (filterDto) {
		...
		is ServiceByHcPartyMonthCodePrefixFilter -> map(filterDto)
		is ServiceByHcPartyMonthTagPrefixFilter -> map(filterDto)
		is ServiceByHcPartyPatientCodePrefixFilter -> map(filterDto)
