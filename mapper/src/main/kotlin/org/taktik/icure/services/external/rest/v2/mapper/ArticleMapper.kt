...
@Mapper(componentModel = "spring", uses = [ContentV2Mapper::class, ServiceV2Mapper::class, CodeStubV2Mapper::class, DelegationV2Mapper::class, SecurityMetadataV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
