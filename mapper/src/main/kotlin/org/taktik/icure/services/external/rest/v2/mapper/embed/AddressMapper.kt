...
interface AddressV2Mapper {
	@Mappings(
		Mapping(target = "extensions", expression = "kotlin(mapperExtensionsValidationContext.validateAndMapEmbeddedExtensionsForStore(addressDto, org.taktik.icure.domain.customentities.config.ExtendableEntityName.Address))", requireMappingContext = true),
	)
