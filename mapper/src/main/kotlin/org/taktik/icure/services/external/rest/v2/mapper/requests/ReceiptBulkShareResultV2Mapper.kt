...
class ReceiptBulkShareResultV2MapperImpl(
	...
	override fun map(bulkShareResultDto: EntityBulkShareResultDto<ReceiptDto>): EntityBulkShareResult<Receipt> = EntityBulkShareResult(
	...
	override fun map(bulkShareResult: EntityBulkShareResult<Receipt>): EntityBulkShareResultDto<ReceiptDto> = EntityBulkShareResultDto(
		updatedEntity =
