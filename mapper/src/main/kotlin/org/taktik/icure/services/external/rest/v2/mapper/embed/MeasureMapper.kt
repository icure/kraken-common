...
@Mapper(componentModel = "spring", uses = [CodeStubV2Mapper::class, ReferenceRangeV2Mapper::class, ScaledValueV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
