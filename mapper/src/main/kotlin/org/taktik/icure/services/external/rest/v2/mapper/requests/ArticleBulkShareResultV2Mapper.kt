...
class ArticleBulkShareResultV2MapperImpl(
	...
	override fun map(bulkShareResultDto: EntityBulkShareResultDto<ArticleDto>): EntityBulkShareResult<Article> = EntityBulkShareResult(
	...
	override fun map(bulkShareResult: EntityBulkShareResult<Article>): EntityBulkShareResultDto<ArticleDto> = EntityBulkShareResultDto(
		updatedEntity =
