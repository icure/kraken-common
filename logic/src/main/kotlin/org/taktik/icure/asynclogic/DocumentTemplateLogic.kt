...
interface DocumentTemplateLogic : EntityPersister<DocumentTemplate, String> {
	...
	fun getDocumentTemplatesBySpecialty(specialityCode: String, loadLayout: Boolean = true): Flow<DocumentTemplate>
	fun getDocumentTemplatesByDocumentType(documentTypeCode: String, loadLayout: Boolean = true): Flow<DocumentTemplate>
	fun getDocumentTemplatesByDocumentTypeAndUser(documentTypeCode: String, userId: String, loadLayout: Boolean = true): Flow<DocumentTemplate>
	fun getDocumentTemplatesByUser(userId: String, loadLayout: Boolean = true): Flow<DocumentTemplate>
