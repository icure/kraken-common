...
data class TarificationDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val regions: Set<String> = emptySet(), //ex: be,fr
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val periodicity: List<PeriodicityDto> = emptyList(),
	val level: Int? = null, //ex: 0 = System, not to be modified by user, 1 = optional, created or modified by user
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val links: List<String> = emptyList(), //Links towards related codes (corresponds to an approximate link in qualifiedLinks)
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val qualifiedLinks: Map<LinkQualificationDto, List<String>> = emptyMap(), //Links towards related codes
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val flags: Set<CodeFlagDto> = emptySet(), //flags (like female only) for the code
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val searchTerms: Map<String, Set<String>> = emptyMap(), //Extra search terms/ language
	val data: String? = null,
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val appendices: Map<AppendixTypeDto, String> = emptyMap(),
	val disabled: Boolean = false,
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val valorisations: Set<ValorisationDto> = emptySet(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val category: Map<String, String> = emptyMap(),
	val consultationCode: Boolean? = null,
	val hasRelatedCode: Boolean? = null,
	val needsPrescriber: Boolean? = null,
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val relatedCodes: Set<String> = emptySet(),
	@JsonProperty("nGroup")
	val ngroup: String? = null,
	@JsonInclude(JsonInclude.Include.NON_EMPTY) val letterValues: List<LetterValueDto> = emptyList()
