...
data class EntityShareRequestDto(
	...
	@ActiveField val explicitDelegator: String? = null,
	/**
	 ...
	 */
	@ActiveField val explicitDelegate: String? = null,
	/**
	...
	@ActiveField val accessControlKeys: Set<AccessControlKeyHexStringDto>,
	/**
	 ...
	 * cases.
	 */
	@ActiveField val encryptedExchangeDataId: Map<KeypairFingerprintV2StringDto, Base64StringDto> = emptyMap(),
	/**
	 * Permissions for the delegate.
	 */
	@ActiveField val requestedPermissions: RequestedPermissionDto = RequestedPermissionDto.MAX_WRITE,
) {
	init {
