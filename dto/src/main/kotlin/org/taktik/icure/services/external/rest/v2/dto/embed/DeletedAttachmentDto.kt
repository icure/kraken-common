...
data class DeletedAttachmentDto(
	@get:Schema(description = "If the attachment was stored as a couchdb attachment this holds the id of the attachment, else null.")
	val couchDbAttachmentId: String? = null,
	@get:Schema(description = "If the attachment was stored using the object storage servicxe this holds the id of the attachment, else null.")
	...
	val key: String? = null,
	@get:Schema(description = "Instant the attachment was deleted.")
