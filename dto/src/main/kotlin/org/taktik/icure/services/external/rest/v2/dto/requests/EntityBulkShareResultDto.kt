...
data class EntityBulkShareResultDto<T>(
	 ...
	 */
	@ActiveField val updatedEntity: T? = null,
	/**
	 * Id of the entity for which the update was requested.
	 */
	@param:Schema(required = true)
	@ActiveField val entityId: String,
	/**
	 ...
	 */
	@ActiveField val entityRev: String? = null,
	/**
	 ...
	 */
	@ActiveField val rejectedRequests: Map<String, RejectedShareOrMetadataUpdateRequestDto> = emptyMap(),
) {
	/**
	...
	@JsonIgnoreProperties(ignoreUnknown = false)
		 ...
		 */
		@ActiveField val shouldRetry: Boolean = false,
		/**
		 * Human-friendly message explaining the reason of the failure.
		 */
		@param:Schema(required = true)
		@ActiveField val reason: String,
	)
