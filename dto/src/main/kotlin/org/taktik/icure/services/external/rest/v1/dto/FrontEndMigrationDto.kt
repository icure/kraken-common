...
data class FrontEndMigrationDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Extra properties for the fem. Those properties are typed (see class Property)") val properties: Set<PropertyStubDto> = emptySet(),
