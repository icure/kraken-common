...
data class PatientDto(
	...
	@Schema(description = "the gender of the patient: male, female, indeterminate, changed, changedToMale, changedToFemale, unknown", defaultValue = "GenderDto.unknown") override val gender: GenderDto? = GenderDto.unknown,
	@Schema(description = "the birth sex of the patient: male, female, indeterminate, unknown", defaultValue = "GenderDto.unknown") val birthSex: GenderDto? = GenderDto.unknown,
	...
	@Schema(description = "any of `single`, `in_couple`, `married`, `separated`, `divorced`, `divorcing`, `widowed`, `widower`, `complicated`, `unknown`, `contract`, `other`.", defaultValue = "PersonalStatusDto.unknown") val personalStatus: PersonalStatusDto? = PersonalStatusDto.unknown,
	...
	@Schema(description = "Localized text notes (can be confidential).") val notes: List<AnnotationDto> = emptyList(),
