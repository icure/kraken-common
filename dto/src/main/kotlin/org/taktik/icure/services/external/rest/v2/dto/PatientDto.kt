...
@Schema(
	...
	extensions = [Extension(name = "is-deprecated", properties = [ExtensionProperty(name = "fatherBirthCountry", value = "true"), ExtensionProperty(name = "birthCountry", value = "true"), ExtensionProperty(name = "nativeCountry", value = "true"), ExtensionProperty(name = "socialStatus", value = "true"), ExtensionProperty(name = "mainSourceOfIncome", value = "true")])]
)
data class PatientDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "the list of all names of the patient, also containing the official full name information. Ordered by preference of use. First element is therefore the official name used for the patient in the application") override val names: List<PersonNameDto> = emptyList(),
	@Schema(description = "the name of the company this patient is member of.") override val companyName: String? = null,
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "the list of languages spoken by the patient ordered by fluency (alpha-2 code http://www.loc.gov/standards/iso639-2/ascii_8bits.html).") override val languages: List<String> = emptyList(), //alpha-2 code http://www.loc.gov/standards/iso639-2/ascii_8bits.html,
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "The ids of the patients that have been merged inside this patient.") val mergedIds: Set<String> = emptySet(),
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Localized text notes (can be confidential).") val notes: List<AnnotationDto> = emptyList(),
	@Schema(description = "A text note (can be confidential, encrypted by default).", deprecated = true) val note: String? = null,
	@Schema(description = "An administrative note, not confidential.", deprecated = true) val administrativeNote: String? = null,
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of insurance coverages (of class Insurability, see below).") val insurabilities: List<InsurabilityDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of partners, or persons of contact (of class Partnership, see below).") val partnerships: List<PartnershipDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Links (usually for therapeutic reasons) between this patient and healthcare parties (of class PatientHealthcareParty).") val patientHealthCareParties: List<PatientHealthCarePartyDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Financial information (Bank, bank account) used to reimburse the patient.") val financialInstitutionInformation: List<FinancialInstitutionInformationDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Contracts between the patient and the healthcare entity.") val medicalHouseContracts: List<MedicalHouseContractDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Codified list of professions exercised by this patient.") val patientProfessions: List<CodeStubDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Extra parameters") val parameters: Map<String, List<String>> = emptyMap(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Extra properties") val properties: Set<PropertyStubDto> = emptySet(),
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @get:Deprecated("Do not use") val nonDuplicateIds: Set<String> = emptySet(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @get:Deprecated("Do not use") val encryptedAdministrativesDocuments: Set<String> = emptySet(),
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @get:Deprecated("Use properties instead") val schoolingInfos: List<SchoolingInfoDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @get:Deprecated("Use properties instead") val employementInfos: List<EmploymentInfoDto> = emptyList(),
