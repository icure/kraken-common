...
data class ServiceDto(
	...
	@param:Schema(description = "The secret patient key, encrypted in the patient document, in clear here.") val secretForeignKeys: Set<String>? =
	...
	@param:Schema(description = "Id of the form used during the Service") val formId: String? = null, // Used to group logically related services
