...
data class GroupDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Extra properties for the user. Those properties are typed (see class Property)") val properties: Set<PropertyStubDto> = emptySet(),
