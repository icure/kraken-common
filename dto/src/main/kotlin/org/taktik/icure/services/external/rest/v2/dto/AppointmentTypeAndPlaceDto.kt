...
data class AppointmentTypeAndPlaceDto(
	...
	@param:Schema(defaultValue = "emptyMap()") @ActiveField val subjectByLanguage: Map<String, String>? = emptyMap(),
	...
	@param:Schema(defaultValue = "true") @ActiveField val acceptsNewPatients: Boolean = true,
)
