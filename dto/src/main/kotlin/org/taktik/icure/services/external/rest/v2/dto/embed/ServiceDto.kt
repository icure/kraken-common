...
data class ServiceDto(
	...
	/** List of IDs of all sub-contacts that link the service to structural elements. Only used when the Service is emitted outside its contact */
	...
	/** List of IDs of all plans of actions (healthcare approaches) as a part of which the Service is provided. Only used when the Service is emitted outside its contact */
	...
	/** List of IDs of all healthcare elements for which the service is provided. Only used when the Service is emitted outside its contact */
	...
	/** List of Ids of all forms linked to the Service. Only used when the Service is emitted outside its contact. */
	...
	/** The secret patient key, encrypted in the patient document, in clear here. Only used when the Service is emitted outside its contact */
	@param:Schema(
	...
	/** The public patient key, encrypted here for separate Crypto Actors. Only used when the Service is emitted outside its contact */
	...
	/** The delegations giving access to connected healthcare information. Only used when the Service is emitted outside its contact */
	...
	/** The contact secret encryption key used to encrypt the secured properties (like services for example), encrypted for separate Crypto Actors. Only used when the Service is emitted outside its contact */
	...
	/** The id of the User that has created this service, will be filled automatically if missing. Not enforced by the application server. */
	override val author: String? = null, // userId
	/** The id of the HealthcareParty that is responsible for this service, will be filled automatically if missing. Not enforced by the application server. */
	override val responsible: String? = null, // healthcarePartyId
	/** The id of the medical location where the service was recorded. */
	@Deprecated("This field is deprecated for the use with Cardinal SDK")
