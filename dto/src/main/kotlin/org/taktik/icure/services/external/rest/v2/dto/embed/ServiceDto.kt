...
data class ServiceDto(
	...
	@Schema(description = "The secret patient key, encrypted in the patient document, in clear here.", defaultValue = "emptySet()") val secretForeignKeys: Set<String>? = emptySet(), //Only used when the ServiceDto is emitted outside of its contact
