...
data class EntitySharedMetadataUpdateRequestDto(
	...
	@ActiveField val metadataAccessControlHash: SecureDelegationKeyStringDto,
	/**
	 ...
	 */
	@ActiveField val secretIds: Map<Base64StringDto, EntryUpdateTypeDto> = emptyMap(),
	/**
	 ...
	 */
	@ActiveField val encryptionKeys: Map<Base64StringDto, EntryUpdateTypeDto> = emptyMap(),
	/**
	 ...
	 */
	@ActiveField val owningEntityIds: Map<Base64StringDto, EntryUpdateTypeDto> = emptyMap(),
)
