...
interface HasEncryptionMetadataDto : VersionableDto<String> {
	...
	@ActiveField val cryptedForeignKeys: Map<String, Set<DelegationDto>>

	@get:Schema(
		description = "When a document is created, the responsible generates a cryptographically random master key (never to be used for something else than referencing from other entities). He/she encrypts it using his own AES exchange key and stores it as a delegation. The responsible is thus always in the delegations as well",
	)
	@ActiveField val delegations: Map<String, Set<DelegationDto>>
	...
	@ActiveField val encryptionKeys: Map<String, Set<DelegationDto>>

	@get:Schema(
		description = """Security metadata for the entity, contains metadata necessary for access control.
...
and secret id (replacing the keys of [Encryptable.delegations]).""",
	...
	@ActiveField val securityMetadata: SecurityMetadataDto?
}
