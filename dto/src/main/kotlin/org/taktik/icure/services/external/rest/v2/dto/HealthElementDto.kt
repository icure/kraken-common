...
data class HealthElementDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of healthcare approaches.") val plansOfAction: List<PlanOfActionDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of episodes of occurrences of the healthcare element.") val episodes: List<EpisodeDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of care team members assigned for the healthcare element.") val careTeam: List<CareTeamMemberDto> = emptyList(),
