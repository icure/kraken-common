...
data class HealthElementDto(
	...
	@ActiveField val valueDate: Long? = null, // YYYYMMDDHHMMSS if unknown, 00, ex:20010800000000. Note that to avoid all confusion: 2015/01/02 00:00:00 is encoded as 20150101235960.
	/** The date (unix epoch in ms) of the start of the healthcare element. */
	@param:Schema(description = "The date (unix epoch in ms) of the start of the healthcare element.") @ActiveField val openingDate: Long? = null, // YYYYMMDDHHMMSS if unknown, 00, ex:20010800000000. Note that to avoid all confusion: 2015/01/02 00:00:00 is encoded as 20150101235960.
	/** The date (unix epoch in ms) marking the end of the healthcare element. */
	@param:Schema(description = "The date (unix epoch in ms) marking the end of the healthcare element.") @ActiveField val closingDate: Long? = null, // YYYYMMDDHHMMSS if unknown, 00, ex:20010800000000. Note that to avoid all confusion: 2015/01/02 00:00:00 is encoded as 20150101235960.
	/** Description of the healthcare element. */
	@param:Schema(description = "Description of the healthcare element.") @ActiveField val descr: String? = null,
	/** A text note (can be confidential, encrypted by default). */
	@param:Schema(description = "A text note (can be confidential, encrypted by default).") @ActiveField val note: String? = null,
	...
	@param:Schema(description = "If the healthcare element is relevant or not (Set relevant by default).", defaultValue = "true") @ActiveField val relevant: Boolean = true,
	/** Id of the opening contact when the healthcare element was created. */
	@param:Schema(description = "Id of the opening contact when the healthcare element was created.") @ActiveField val idOpeningContact: String? = null,
	/** Id of the closing contact for the healthcare element. */
	@param:Schema(description = "Id of the closing contact for the healthcare element.") @ActiveField val idClosingContact: String? = null,
	/** Id of the service when a service is used to create a healthcare element. */
	@param:Schema(description = "Id of the service when a service is used to create a healthcare element.") @ActiveField val idService: String? = null, // When a service is used to create the healthElement
	...
	@param:Schema(description = "List of healthcare approaches.") @ActiveField val plansOfAction: List<PlanOfActionDto> = emptyList(),
	...
	@param:Schema(description = "The parties asserting that the patient has this healthcare element, i.e. on whose word the healthcare element is held to be true. This field is encrypted.") @ActiveField val asserters: List<HealthElementAsserterDto> = emptyList(),
