...
data class AddressDto(
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "Additional notes") val notes: List<AnnotationDto> = emptyList(),
	@JsonInclude(JsonInclude.Include.NON_EMPTY) @Schema(description = "List of other contact details available through telecom services, ex: email, phone number, fax, etc.") val telecoms: List<TelecomDto> = emptyList(),
