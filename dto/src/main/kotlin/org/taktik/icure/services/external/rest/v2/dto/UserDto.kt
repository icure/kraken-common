...
import org.taktik.icure.services.external.rest.v2.dto.enums.UsersStatus
import org.taktik.icure.services.external.rest.v2.dto.enums.UsersType
...
data class UserDto(
	...
	@Schema(description = "Authorization source for user. 'Database', 'ldap' or 'token'") val type: UsersType? = null,
	@Schema(description = "State of user's activeness: 'Active', 'Disabled' or 'Registering'") val status: UsersStatus? = null,
