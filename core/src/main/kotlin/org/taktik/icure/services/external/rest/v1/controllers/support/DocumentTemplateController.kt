...
class DocumentTemplateController(
	...
	fun deleteDocumentTemplate(
		@PathVariable documentTemplateIds: String,
	): Flux<DocIdentifierDto> {
		val documentTemplateIdsList = documentTemplateIds.split(',').toSet()
		return documentTemplateService
			.deleteDocumentTemplates(documentTemplateIdsList.map { IdAndRev(it, null) })
	...
	fun findDocumentTemplatesByDocumentType(
	...
	fun findDocumentTemplatesByDocumentTypeForCurrentUser(
		@PathVariable documentTypeCode: String,
		@RequestParam(required = false) loadAttachment: Boolean? = null,
