...
class CodeController(
	...
	@Operation(
		summary = "Get a code",
		description = "Get a code based on (type, code, version) as query strings. (type, code, version) is unique.",
	)
	...
	fun filterCodesBy(
		...
		codeService
			.listCodes(paginationOffset, filterChainMapper.tryMap(filterChain).orThrow(), sort, desc)
