...
class PatientDAOImpl(
    ...
    override suspend fun countByHcParty(datastoreInformation: IDatastoreInformation, healthcarePartyId: String): Int {
        ...
        return try {
            (client.queryView<Array<String>, Int>(legacyViewQuery).first().value
                ?: 0) + (client.queryView<Array<String>, Int>(viewQuery).first().value ?: 0)
    ...
    override fun listPatientIdsByHcParty(datastoreInformation: IDatastoreInformation, healthcarePartyId: String) =
        flow {
            val client = couchDbDispatcher.getClient(datastoreInformation)
    ...
    override fun findPatientsByHcPartyDateOfBirth(
        ...
        return findPatientsByDateOfBirth(
            datastoreInformation,
            startDate,
            endDate,
            healthcarePartyId,
