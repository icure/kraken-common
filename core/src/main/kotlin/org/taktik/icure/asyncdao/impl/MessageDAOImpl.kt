...
open class MessageDAOImpl(
	...
	override fun listMessagesByFromAddress(
		...
		val viewQueries = createPagedQueries(
			...
			configurationView = "by_all_delegates_from_address",
			startKey = startKey,
			endKey = endKey,
	...
	override fun findMessagesByToAddress(
		...
		val viewQueries = createPagedQueries(
			...
			configurationView = "by_all_delegates_to_address",
			startKey = startKey,
			endKey = endKey,
			pagination = paginationOffset,
			descending = reverse,
	...
	override fun findMessagesByTransportGuid(
		...
		val viewQueries = createPagedQueries(
			...
			configurationView = "by_all_delegates_transport_guid",
			startKey = startKey,
			endKey = endKey,
			pagination = paginationOffset,
			descending = false,
	...
	override fun findMessagesByTransportGuidReceived(
		...
		val viewQueries = createPagedQueries(
			...
			configurationView = "by_all_delegates_transport_guid_received",
			startKey = startKey,
			endKey = endKey,
			pagination = paginationOffset,
			descending = false,
	...
	override fun findMessagesByTransportGuidAndSentDate(datastoreInformation: IDatastoreInformation, partyId: String, transportGuid: String, fromDate: Long, toDate: Long, paginationOffset: PaginationOffset<ComplexKey>) = flow {
		...
		val viewQueries = createPagedQueries(
			...
			configurationView = "by_all_delegates_transport_guid_sent_date",
			startKey = startKey,
			endKey = endKey,
			pagination = paginationOffset,
			descending = false,
