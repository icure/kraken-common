...
@View(
	name = "all",
	map = "function(doc) { if (doc.java_type == 'org.taktik.icure.entities.HealthElement' && !doc.deleted) emit( null, doc._id )}",
)
internal class HealthElementDAOImpl(
	...
	entityClass = HealthElement::class.java,
	...
	override fun listHealthElementIdsByHcParty(
	...
	override fun listHealthElementIdsByHcPartyAndSecretPatientKeys(
		...
		emitAll(
			client
				.interleave<Array<String>, Long>(viewQueries, compareBy({ it[0] }, { it[1] }))
	...
	@Views(
		...
		View(
			name = "by_data_owner_and_codes",
			map = "classpath:js/healthelement/By_data_owner_code_map.js",
	...
	@Views(
		...
		View(
			name = "by_data_owner_and_tags",
			map = "classpath:js/healthelement/By_data_owner_tag_map.js",
			secondaryPartition = DATA_OWNER_PARTITION,
		),
	)
	...
	@Views(
		...
		View(
			name = "by_data_owner_and_status",
			map = "classpath:js/healthelement/By_data_owner_status_map.js",
			secondaryPartition = DATA_OWNER_PARTITION,
		),
	)
	override fun listHealthElementIdsByHcPartyAndStatus(
		datastoreInformation: IDatastoreInformation,
		searchKeys: Set<String>,
		status: Int?,
	) = flow {
	...
	@Views(
		View(
			...
			map = "classpath:js/healthelement/By_hcparty_identifiers_map.js",
			secondaryPartition = MAURICE_PARTITION,
		),
		View(
			name = "by_data_owner_and_identifiers",
			map = "classpath:js/healthelement/By_data_owner_identifiers_map.js",
			secondaryPartition = DATA_OWNER_PARTITION,
		),
	)
	...
	override suspend fun getHealthElement(
		datastoreInformation: IDatastoreInformation,
		healthElementId: String,
	): HealthElement? = get(datastoreInformation, healthElementId)
	...
	@Views(
		...
		View(
			...
			map = "classpath:js/healthelement/By_hcparty_patient_date.js",
			secondaryPartition = MAURICE_PARTITION,
		),
		View(
			name = "by_data_owner_patient",
			map = "classpath:js/healthelement/By_data_owner_patient_map.js",
			secondaryPartition = DATA_OWNER_PARTITION,
		),
	)
	override fun listHealthElementsByHCPartyAndSecretPatientKeys(
		...
		emitAll(
			client
				.interleave<Array<String>, String, HealthElement>(viewQueries, compareBy({ it[0] }, { it[1] }))
				.filterIsInstance<ViewRowWithDoc<Array<String>, String, HealthElement>>()
				.map { it.doc }
				.distinctById(),
		)
	}
