...
import org.taktik.icure.entities.embed.AsserterType
...
import org.taktik.icure.entities.embed.MhcSignatureType
import org.taktik.icure.entities.embed.PartnerType
...
import org.taktik.icure.services.`external`.rest.v2.dto.embed.AsserterTypeDto
...
import org.taktik.icure.services.`external`.rest.v2.dto.embed.PartnerTypeDto
...
public class ExtendableBuiltinEntitiesValidationConfig {
    ...
    public fun provider(
        ...
        ExtendableBuiltinEntityValidatorMapperObjectProviderBuilder(
            ...
            addMapperForBuiltinEnum<DocumentLocationDto, DocumentLocation>()
            ...
            addMapperForBuiltinEnum<DataOwnerGroupLinkTypeDto, DataOwnerGroupLinkType>()
            addMapperForBuiltinEnum<GenderDto, Gender>()
            addMapperForBuiltinEnum<PersonalStatusDto, PersonalStatus>()
            addMapperForBuiltinEnum<HealthcarePartyStatusDto, HealthcarePartyStatus>()
            addMapperForBuiltinEnum<ParticipantTypeDto, ParticipantType>()
            addMapperForBuiltinEnum<PartnershipTypeDto, PartnershipType>()
            addMapperForBuiltinEnum<PartnershipStatusDto, PartnershipStatus>()
            addMapperForBuiltinEnum<PartnerTypeDto, PartnerType>()
            addMapperForBuiltinEnum<PatientHealthCarePartyTypeDto, PatientHealthCarePartyType>()
            addMapperForBuiltinEnum<ContractChangeTypeDto, ContractChangeType>()
            addMapperForBuiltinEnum<SuspensionReasonDto, SuspensionReason>()
            addMapperForBuiltinEnum<MhcSignatureTypeDto, MhcSignatureType>()
            addMapperForBuiltinEnum<FlatRateTypeDto, FlatRateType>()
            addMapperForBuiltinEnum<TypedValuesTypeDto, TypedValuesType>()
            addMapperForBuiltinEnum<AsserterTypeDto, AsserterType>()
        }.build()
}
