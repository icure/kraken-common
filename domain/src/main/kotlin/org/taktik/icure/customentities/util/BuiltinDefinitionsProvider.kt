...
fun BuiltinDefinitionsProvider.getRequiredObjectDefinition(
	reference: String
): BuiltinDefinitionsProvider.BuiltinObjectDefinition = getBuiltinObjectDefinition(reference)
...
fun BuiltinDefinitionsProvider.getRequiredEnumDefinition(
	reference: String
): BuiltinDefinitionsProvider.BuiltinEnumDefinition = getBuiltinEnumDefinition(reference)
	?: throw IllegalEntityException("Object definition for reference `$reference` not found")