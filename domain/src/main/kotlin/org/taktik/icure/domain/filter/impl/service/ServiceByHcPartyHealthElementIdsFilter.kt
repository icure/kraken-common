...
data class ServiceByHcPartyHealthElementIdsFilter(
	...
	org.taktik.icure.domain.filter.service.ServiceByHcPartyHealthElementIdsFilter {
	...
	override fun matches(item: Service, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = throw UnsupportedOperationException("This filter cannot be used in websocket.")
}
