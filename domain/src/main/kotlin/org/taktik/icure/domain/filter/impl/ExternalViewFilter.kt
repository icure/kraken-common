...
data class ExternalViewFilter<O : Identifiable<String>>(
	...
	org.taktik.icure.domain.filter.ExternalViewFilter<O> {

	override val canBeUsedInWebsocket = false
	override val requiresSecurityPrecondition: Boolean = false
	override fun requestedDataOwnerIds(): Set<String> = emptySet()

	override fun matches(item: O, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = throw UnsupportedOperationException("This filter cannot be used in websocket")
}
