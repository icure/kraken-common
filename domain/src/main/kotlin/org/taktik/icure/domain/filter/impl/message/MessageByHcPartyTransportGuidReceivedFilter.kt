...
data class MessageByHcPartyTransportGuidReceivedFilter(
    ...
    override fun matches(item: Message, searchKeyMatcher: (String, org.taktik.icure.entities.base.HasEncryptionMetadata) -> Boolean): Boolean =
        searchKeyMatcher(healthcarePartyId, item) && transportGuid == item.transportGuid
}
