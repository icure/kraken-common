...
data class MedicalLocationByPostCodeFilter(
	...
	MedicalLocationByPostCodeFilter {

	override val canBeUsedInWebsocket = true
	override val requiresSecurityPrecondition: Boolean = true
	override fun requestedDataOwnerIds(): Set<String> = emptySet()

	override fun matches(item: MedicalLocation, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = item.address?.postalCode == postCode
}
