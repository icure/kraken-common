...
data class PatientByHcPartyAndIdentifiersFilter(
	...
	org.taktik.icure.domain.filter.patient.PatientByHcPartyAndIdentifiersFilter {
	...
	override fun matches(item: Patient, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = item.endOfLife == null &&
