...
data class ServiceBySecretForeignKeys(
	...
	org.taktik.icure.domain.filter.service.ServiceBySecretForeignKeys {
	...
	override fun matches(item: Service, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = patientSecretForeignKeys.isNotEmpty() &&
