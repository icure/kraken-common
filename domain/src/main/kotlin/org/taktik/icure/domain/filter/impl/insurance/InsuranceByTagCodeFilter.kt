...
data class InsuranceByTagCodeFilter(
	...
	org.taktik.icure.domain.filter.insurance.InsuranceByTagCodeFilter {
	init {
		if (tagCode != null) {
	...
	override fun matches(item: Insurance, searchKeyMatcher: (String, HasEncryptionMetadata) -> Boolean): Boolean = (tagType == null || item.tags.containsStubWithTypeAndCode(tagType, tagCode)) &&
