...
data class AgendaByTypedPropertyFilter(
	...
	private fun PropertyStub.matchesTypedValueOf(other: PropertyStub): Boolean = (typedValue?.stringValue != null && other.typedValue?.stringValue == typedValue.stringValue) ||
