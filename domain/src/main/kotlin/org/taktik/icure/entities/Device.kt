 ...
 * @property publicKeysForOaepWithSha256 The public keys of this actor that are generates using the OAEP Sha-256 standard
 * @property externalId A non-official id for the device. This one is not guaranteed to be unique in databases.
