 ...
 *
 * The two fields must agree: [asserterType] declares which kind of entity [asserterId] points at. [AsserterType] bounds
 * the vocabulary, but nothing enforces the *pairing* - the field is encrypted, so the server never sees the values and
 * cannot validate or repair them; that invariant is owned by the SDK. See ADR 0006.
 *
 ...
 * [org.taktik.icure.entities.base.ParticipantType], which qualifies the *role* a party played rather than the kind of
 * entity it is.
 */
